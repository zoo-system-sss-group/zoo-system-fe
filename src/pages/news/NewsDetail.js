...
export function NewsDetail() {
  ...
  return (
    <div>
      ...
      <section className="container mx-auto flex flex-wrap justify-between gap-2 items-start m-2 md:my-10">
        {loading ? (
          <div className="loading h-[800px] m-auto block "></div>
        ) : (
          <>
            <div className="w-[96%] mx-auto md:w-[64%] shadow-lg rounded-lg bg-cor4 mx text-cor2 p-6">
              ...
              <div className="flex flex-col justify-center ">
                {newsObj.thumbnail && (
                  <img
                    className="image-full rounded-md shadow-lg bg-transparent w-full lg:w-2/3 block m-auto max-w-[500px] min-h-[16rem] my-6"
            ...
            <div className="w-full sm:w-1/3 rounded-lg  text-cor2 ">
              <div className="z-10">
                {news.map((newObj) => (
                  <div className="relative">
                    ...
                    <div className="ps-2 my-1 hover:translate-x-5 transition relative rounded-lg  bg-cor5  ">
                      ...
                      >
                        <li className="list-item py-2 pe-4 list-none list-inside overflow-hidden">
                          {newObj.title}
                        </li>
                      </Link>
                    </div>
