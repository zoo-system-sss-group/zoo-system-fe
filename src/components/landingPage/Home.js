...
const Home = () => {
  return (
    <section
      className="h-screen w-full py-12 flex flex-col text-cor2 bg-[url('/src/assets/img-entrada-2.jpg')] bg-center bg-cover shadow-[inset_0_250px_10px_rgba(9,11,9,0.3)] sm:shadow-[inset_0_250px_70px_rgba(9,11,9,0.3)]"
    >
      <div className="flex flex-col items-center sm:items-stretch flex-1 sm:flex-row text-center sm:text-left pt-28 pb-4 px-6 sm:py-14 sm:px-12">
        ...
        <div className={classes.aside}>
          ...
          <address className="text-center mt-8 not-italic">
            <span>
            <IconPin className="inline mr-1"/>D1 Street, Saigon Hi-tech Park, Long Thanh My Ward, Thu Duc City,
              Ho Chi Minh City 
            </span>
          </address>
        </div>
